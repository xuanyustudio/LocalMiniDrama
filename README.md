...
<table>
  <tr>
    <td align="center"><img src="项目截图/武侠.png" alt="项目列表页" width="480"/><br/><sub>项目列表 · 支持导出/导入工程</sub></td>
...
**最新版 v1.1.6 亮点：**
- 🆕 **工程导出/导入**：完整打包工程为 ZIP，含所有图片、视频、配置与文字
- 🆕 **画面比例设置**：项目级别选定比例，生成图片/视频全程自动适配
- 🆕 **视频参数扩展**：支持 `resolution`、`seed`、`camera_fixed`、`watermark` 等参数
- 🆕 **视频合并进度**：合成大视频时前端实时展示合并进度
- 🔧 **图片无水印**：火山引擎图片生成默认关闭水印
...
<img src="项目截图/wx.jpg" alt="微信二维码" width="200" />
